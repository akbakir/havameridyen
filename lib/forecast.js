...
export const MODELS = [
  ...
  { id: "gem_seamless", label: "GEM", color: "#B4553B", dashed: true, defaultActive: true },
  { id: "meteofrance_seamless", label: "Météo-France", color: "#7A6C4F", dashed: false, defaultActive: false },
  { id: "ukmo_seamless", label: "UK Met Office", color: "#4F6B7A", dashed: true, defaultActive: false },
  { id: "jma_gsm", label: "JMA", color: "#8A6FA3", dashed: false, defaultActive: false },
  { id: "knmi_seamless", label: "KNMI", color: "#5C8A5C", dashed: true, defaultActive: false },
];

...
// Ana sayfadaki şehir listesi ve şehir sayfasındaki hızlı seçim çipleri aynı listeyi kullanır,
// böylece kullanıcı ana sayfadan şehir sayfasına geçtiğinde sıralama "karışmaz".
export const HOME_CITIES = [
  { name: "İstanbul", lat: 41.01, lon: 28.98 },
  { name: "Ankara", lat: 39.93, lon: 32.86 },
  { name: "İzmir", lat: 38.42, lon: 27.14 },
  { name: "İzmit", lat: 40.77, lon: 29.94 },
  { name: "Antalya", lat: 36.9, lon: 30.71 },
];

export const CITY_CHIPS = HOME_CITIES;